...
export const CenteredLayout = ({ children, maxWidth = 896, className }: CenteredLayoutProps) => {
  return (
    <div
      className={cn(
        'relative flex min-h-screen flex-col items-center justify-center px-[clamp(16px,4vw,40px)] py-[clamp(24px,4vw,56px)]',
