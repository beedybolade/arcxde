/*
  ...
  - You are about to drop the column `correct_answer` on the `onboarding_questions` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "onboarding_questions" DROP COLUMN "correct_answer",
ADD COLUMN     "option_weights" JSONB NOT NULL DEFAULT '[]',
